	...
	implements \Aimeos\MShop\Post\Manager\Lists\Type\Iface, \Aimeos\MShop\Common\Manager\Factory\Iface
{
	...
	public function clear( array $siteids ) : \Aimeos\MShop\Common\Manager\Iface
	{
		...
		return $this->clearBase( $siteids, 'mshop/post/manager/lists/type/standard/delete' );
	}
	...
	public function getSubManager( string $manager, string $name = null ) : \Aimeos\MShop\Common\Manager\Iface
	{
		 ...
		 * ("\Aimeos\MShop\Common\Manager\Decorator\*") around the post list
		 * type manager.
		 *
		 ...
		 * ("\Aimeos\MShop\Post\Manager\Lists\Type\Decorator\*") around the
		 * post list type manager.
		 *
		 *  mshop/post/manager/lists/type/decorators/local = array( 'decorator2' )
		 *
		 * This would add the decorator named "decorator2" defined by
		 * "\Aimeos\MShop\Post\Manager\Lists\Type\Decorator\Decorator2" only
		 * to the post list type manager.
		 *
		 * @param array List of decorator names
		 * @since 2014.03
		 * @category Developer
	...
	{
		/** mshop/post/manager/lists/type/standard/insert/mysql
		 * Inserts a new post list type record into the database table
		 *
		 * @see mshop/post/manager/lists/type/standard/insert/ansi
		 */

		/** mshop/post/manager/lists/type/standard/insert/ansi
		 * Inserts a new post list type record into the database table
		 *
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see mshop/post/manager/lists/type/standard/update/ansi
		 * @see mshop/post/manager/lists/type/standard/newid/ansi
		 * @see mshop/post/manager/lists/type/standard/delete/ansi
		 * @see mshop/post/manager/lists/type/standard/search/ansi
		 * @see mshop/post/manager/lists/type/standard/count/ansi
		 */

		/** mshop/post/manager/lists/type/standard/update/mysql
		 * Updates an existing post list type record in the database
		 *
		 * @see mshop/post/manager/lists/type/standard/update/ansi
		 */

		/** mshop/post/manager/lists/type/standard/update/ansi
		 * Updates an existing post list type record in the database
		 *
		...
		/** mshop/post/manager/lists/type/standard/newid/mysql
		 * Retrieves the ID generated by the database when inserting a new record
		 *
		 * @see mshop/post/manager/lists/type/standard/newid/ansi
		 */

		/** mshop/post/manager/lists/type/standard/newid/ansi
		 * Retrieves the ID generated by the database when inserting a new record
		 *
		...
		/** mshop/post/manager/lists/type/standard/delete/mysql
		 * Deletes the items matched by the given IDs from the database
		 *
		 * @see mshop/post/manager/lists/type/standard/delete/ansi
		 */

		/** mshop/post/manager/lists/type/standard/delete/ansi
		 * Deletes the items matched by the given IDs from the database
		 *
		...
		/** mshop/post/manager/lists/type/standard/search/mysql
		 * Retrieves the records matched by the given criteria in the database
		 *
		 * @see mshop/post/manager/lists/type/standard/search/ansi
		 */

		/** mshop/post/manager/lists/type/standard/search/ansi
		 * Retrieves the records matched by the given criteria in the database
		 *
		...
		/** mshop/post/manager/lists/type/standard/count/mysql
		 * Counts the number of records matched by the given criteria in the database
		 *
		 * @see mshop/post/manager/lists/type/standard/count/ansi
		 */

		/** mshop/post/manager/lists/type/standard/count/ansi
		 * Counts the number of records matched by the given criteria in the database
		 *
		...
		return 'mshop/post/manager/lists/type/standard/';
	}
