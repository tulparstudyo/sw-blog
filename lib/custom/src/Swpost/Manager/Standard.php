		...
		\Aimeos\MShop\Common\Manager\Rating\Iface
{
	...
	public function createSearch( bool $default = false ) : \Aimeos\MW\Criteria\Iface
	{
		if( $default === true )
		{
			...
			/** mshop/swpost/manager/standard/strict-events
			 ...
			 *
			 * Setting this configuration option to false will display event swposts
	...
	{
		/** mshop/swpost/manager/standard/delete/mysql
		 * Deletes the items matched by the given IDs from the database
		 *
		 * @see mshop/swpost/manager/standard/delete/ansi
		 */

		/** mshop/swpost/manager/standard/delete/ansi
		 * Deletes the items matched by the given IDs from the database
		 *
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see mshop/swpost/manager/standard/insert/ansi
		 * @see mshop/swpost/manager/standard/update/ansi
		 * @see mshop/swpost/manager/standard/newid/ansi
		 * @see mshop/swpost/manager/standard/search/ansi
		 * @see mshop/swpost/manager/standard/count/ansi
		 */
	...
	{
		/** mshop/swpost/manager/submanagers
		 * List of manager names that can be instantiated by the swpost manager
		 *
	...
	public function rate( string $id, string $rating, int $ratings ) : \Aimeos\MShop\Common\Manager\Iface
	{
		...
		try
		{
			/** mshop/swpost/manager/standard/rate/mysql
			 * Updates the rating of the swpost in the database
			 *
			 * @see mshop/swpost/manager/standard/rate/ansi
			 */

			/** mshop/swpost/manager/standard/rate/ansi
			 * Updates the rating of the swpost in the database
			 *
	...
	public function saveItem( \Aimeos\MShop\Swpost\Item\Iface $item, bool $fetch = true ) : \Aimeos\MShop\Swpost\Item\Iface
	{
		...
		try
		{
			...
			if( $id === null )
			{
				/** mshop/swpost/manager/standard/insert/mysql
				 * Inserts a new swpost record into the database table
				 *
				 * @see mshop/swpost/manager/standard/insert/ansi
				 */

				/** mshop/swpost/manager/standard/insert/ansi
				 * Inserts a new swpost record into the database table
				 *
				 ...
				 * The SQL statement must be a string suitable for being used as
				 * prepared statement. It must include question marks for binding
				 * the values from the swpost item to the statement before they are
			...
			{
				/** mshop/swpost/manager/standard/update/mysql
				 * Updates an existing swpost record in the database
				 *
				 * @see mshop/swpost/manager/standard/update/ansi
				 */

				/** mshop/swpost/manager/standard/update/ansi
				 * Updates an existing swpost record in the database
				 *
			...
			if( $id === null )
			{
				/** mshop/swpost/manager/standard/newid/mysql
				 * Retrieves the ID generated by the database when inserting a new record
				 *
				 * @see mshop/swpost/manager/standard/newid/ansi
				 */

				/** mshop/swpost/manager/standard/newid/ansi
				 * Retrieves the ID generated by the database when inserting a new record
				 *
	...
	public function searchItems( \Aimeos\MW\Criteria\Iface $search, array $ref = [], int &$total = null ) : \Aimeos\Map
	{
		...
		try
		{
			...
			/** mshop/swpost/manager/sitemode
			 * Mode how items from levels below or above in the site tree are handled
			 *
			 * By default, only items from the current site are fetched from the
			 * storage. If the ai-sites extension is installed, you can create a
			 * tree of sites. Then, this setting allows you to define for the
			 * whole swpost domain if items from parent sites are inherited,
			...
			/** mshop/swpost/manager/standard/search/mysql
			 * Retrieves the records matched by the given criteria in the database
			 *
			 * @see mshop/swpost/manager/standard/search/ansi
			 */

			/** mshop/swpost/manager/standard/search/ansi
			 * Retrieves the records matched by the given criteria in the database
			 *
			...
			/** mshop/swpost/manager/standard/count/mysql
			 * Counts the number of records matched by the given criteria in the database
			 *
			 * @see mshop/swpost/manager/standard/count/ansi
			 */

			/** mshop/swpost/manager/standard/count/ansi
			 * Counts the number of records matched by the given criteria in the database
			 *
