...
namespace Aimeos\Admin\JQAdm\Swpost\Category;

sprintf( 'category' ); // for translation


/**
 * Default implementation of swpost category JQAdm client.
 *
 * @package Admin
 * @subpackage JQAdm
 */
...
{
	/** admin/jqadm/swpost/category/name
	 * Name of the category subpart used by the JQAdm swpost implementation
	 *
	 * Use "Myname" if your class is named "\Aimeos\Admin\Jqadm\Swpost\Category\Myname".
	...
	public function delete() : ?string
	{
		...
		$expr = array(
			...
			$search->compare( '==', 'catalog.lists.domain', 'swpost' )
		);
	...
	{
		/** admin/jqadm/swpost/category/decorators/excludes
		 ...
		 *
		 *  admin/jqadm/swpost/category/decorators/excludes = array( 'decorator1' )
		 *
		 ...
		 * @see admin/jqadm/swpost/category/decorators/global
		 * @see admin/jqadm/swpost/category/decorators/local
		 */

		/** admin/jqadm/swpost/category/decorators/global
		 ...
		 *
		 *  admin/jqadm/swpost/category/decorators/global = array( 'decorator1' )
		 *
		 ...
		 * @category Developer
		 * @see admin/jqadm/common/decorators/default
		 * @see admin/jqadm/swpost/category/decorators/excludes
		 * @see admin/jqadm/swpost/category/decorators/local
		 */

		/** admin/jqadm/swpost/category/decorators/local
		 ...
		 *
		 *  admin/jqadm/swpost/category/decorators/local = array( 'decorator2' )
		 *
		 ...
		 * @see admin/jqadm/swpost/category/decorators/global
		 */
		return $this->createSubClient( 'swpost/category/' . $type, $name );
	}
	...
	{
		/** admin/jqadm/swpost/category/standard/subparts
		 * List of JQAdm sub-clients rendered within the swpost category section
		 *
		 ...
		 * @category Developer
		 */
		return $this->getContext()->getConfig()->get( 'admin/jqadm/swpost/category/standard/subparts', [] );
	}
	...
	/**
	 * Returns the category list items for the given swpost ID
	 *
	 ...
	 */
	protected function fromArray( \Aimeos\MShop\Pwpost\Item\Iface $item, array $data )
	{
		$manager = \Aimeos\MShop::create( $this->getContext(), 'catalog/lists' );
		...
		foreach( $data as $idx => $entry )
		{
			...
			$list[] = $litem->setParentId( $this->getValue( $entry, 'catalog.id' ) )->setDomain( 'swpost' )
	...
	{
		/** admin/jqadm/swpost/category/template-item
		 * Relative path to the HTML body template of the category subpart for swposts.
		 *
		 ...
		 * @category Developer
		 */
		$tplconf = 'admin/jqadm/swpost/category/template-item';
		$default = 'swpost/item-category-standard';
