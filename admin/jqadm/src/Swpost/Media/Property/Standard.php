...
namespace Aimeos\Admin\JQAdm\Swpost\Media\Property;
...
{
	/** admin/jqadm/swpost/media/property/name
	 * Name of the property subpart used by the JQAdm swpost media implementation
	 *
	 * Use "Myname" if your class is named "\Aimeos\Admin\Jqadm\Swpost\Media\Property\Myname".
	...
	{
		/** admin/jqadm/swpost/media/property/decorators/excludes
		 ...
		 *
		 *  admin/jqadm/swpost/media/property/decorators/excludes = array( 'decorator1' )
		 *
		 ...
		 * @see admin/jqadm/swpost/media/property/decorators/global
		 * @see admin/jqadm/swpost/media/property/decorators/local
		 */

		/** admin/jqadm/swpost/media/property/decorators/global
		 ...
		 *
		 *  admin/jqadm/swpost/media/property/decorators/global = array( 'decorator1' )
		 *
		 ...
		 * @category Developer
		 * @see admin/jqadm/common/decorators/default
		 * @see admin/jqadm/swpost/media/property/decorators/excludes
		 * @see admin/jqadm/swpost/media/property/decorators/local
		 */

		/** admin/jqadm/swpost/media/property/decorators/local
		 ...
		 *
		 *  admin/jqadm/swpost/media/property/decorators/local = array( 'decorator2' )
		 *
		 ...
		 * @see admin/jqadm/swpost/media/property/decorators/global
		 */
		return $this->createSubClient( 'swpost/media/property/' . $type, $name );
	}
	...
	{
		/** admin/jqadm/swpost/media/property/standard/subparts
		 * List of JQAdm sub-clients rendered within the swpost media property section
		 *
		 ...
		 * @category Developer
		 */
		return $this->getContext()->getConfig()->get( 'admin/jqadm/swpost/media/property/standard/subparts', [] );
	}
	...
	{
		/** admin/jqadm/swpost/media/property/template-item
		 ...
		 * @category Developer
		 */
		$tplconf = 'admin/jqadm/swpost/media/property/template-item';
		$default = 'swpost/item-media-property-standard';
