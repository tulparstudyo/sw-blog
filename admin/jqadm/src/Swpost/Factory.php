...
/**
 * Factory for swpost JQAdm client
 *
 * @package Admin
 * @subpackage JQAdm
 */
	...
	implements \Aimeos\Admin\JQAdm\Common\Factory\Iface
{
	...
	public static function create( \Aimeos\MShop\Context\Item\Iface $context, string $name = null ) : \Aimeos\Admin\JQAdm\Iface
	{
		 ...
		 *
		 *  \Aimeos\Admin\JQAdm\Swpost\Standard
		 *
		 * and you want to replace it with your own version named
		 *
		 *  \Aimeos\Admin\JQAdm\Swpost\Myfavorite
		 *
		 * then you have to set the this configuration option:
		 *
		 *  admin/jqadm/swpost/name = Myfavorite
		 *
		 ...
		 */
		if( $name === null ) {
			$name = $context->getConfig()->get( 'admin/jqadm/swpost/name', 'Standard' );
		}

		$iface = '\\Aimeos\\Admin\\JQAdm\\Iface';
		$classname = '\\Aimeos\\Admin\\JQAdm\\Swpost\\' . $name;
		...
		return self::addClientDecorators( $context, $client, 'swpost' );
	}
