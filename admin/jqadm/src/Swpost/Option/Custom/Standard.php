...
namespace Aimeos\Admin\JQAdm\Swpost\Option\Custom;


/**
 * Default implementation of swpost custom JQAdm client.
 *
 * @package Admin
 * @subpackage JQAdm
 */
...
{
	/** admin/jqadm/swpost/option/custom/name
	 * Name of the option/custom subpart used by the JQAdm swpost implementation
	 *
	 * Use "Myname" if your class is named "\Aimeos\Admin\Jqadm\Swpost\Option\Custom\Myname".
	...
	{
		/** admin/jqadm/swpost/option/custom/decorators/excludes
		 ...
		 *
		 *  admin/jqadm/swpost/option/custom/decorators/excludes = array( 'decorator1' )
		 *
		 ...
		 * @see admin/jqadm/swpost/option/custom/decorators/global
		 * @see admin/jqadm/swpost/option/custom/decorators/local
		 */

		/** admin/jqadm/swpost/option/custom/decorators/global
		 ...
		 *
		 *  admin/jqadm/swpost/option/custom/decorators/global = array( 'decorator1' )
		 *
		 ...
		 * @category Developer
		 * @see admin/jqadm/common/decorators/default
		 * @see admin/jqadm/swpost/option/custom/decorators/excludes
		 * @see admin/jqadm/swpost/option/custom/decorators/local
		 */

		/** admin/jqadm/swpost/option/custom/decorators/local
		 ...
		 *
		 *  admin/jqadm/swpost/option/custom/decorators/local = array( 'decorator2' )
		 *
		 ...
		 * @see admin/jqadm/swpost/option/custom/decorators/global
		 */
		return $this->createSubClient( 'swpost/option/custom/' . $type, $name );
	}
	...
	{
		/** admin/jqadm/swpost/option/custom/standard/exclude
		 ...
		 */
		return $this->getContext()->getConfig()->get( 'admin/jqadm/swpost/option/custom/standard/exclude', [] );
	}
	...
	{
		/** admin/jqadm/swpost/option/custom/standard/subparts
		 * List of JQAdm sub-clients rendered within the swpost custom section
		 *
		 ...
		 * @category Developer
		 */
		return $this->getContext()->getConfig()->get( 'admin/jqadm/swpost/option/custom/standard/subparts', [] );
	}
	...
	protected function fromArray( \Aimeos\MShop\Swpost\Item\Iface $item, array $data ) : \Aimeos\MShop\Swpost\Item\Iface
	{
		...
		foreach( $data as $idx => $entry )
		{
			if( isset( $listItems[$entry['swpost.lists.id']] ) ) {
				...
				$litem = $listManager->createItem()->setType( 'custom' );
			}
	...
	{
		/** admin/jqadm/swpost/option/custom/template-item
		 * Relative path to the HTML body template of the custom option subpart for swposts.
		 *
		 ...
		 * @category Developer
		 */
		$tplconf = 'admin/jqadm/swpost/option/custom/template-item';
		$default = 'swpost/item-option-custom-standard';
