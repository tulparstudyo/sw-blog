...
namespace Aimeos\Admin\JQAdm\Swpost\Physical;

sprintf( 'physical' ); // for translation


/**
 * Default implementation of swpost physical JQAdm client.
 *
 * @package Admin
 * @subpackage JQAdm
 */
...
{
	/** admin/jqadm/swpost/physical/name
	 * Name of the physical subpart used by the JQAdm swpost implementation
	 *
	 * Use "Myname" if your class is named "\Aimeos\Admin\Jqadm\Swpost\Physical\Myname".
	...
	public function create() : ?string
	{
		...
		foreach( $view->value( $data, 'swpost.property.id', [] ) as $idx => $value ) {
			$data['swpost.property.siteid'][$idx] = $siteid;
		}
	...
	{
		/** admin/jqadm/swpost/physical/decorators/excludes
		 ...
		 *
		 *  admin/jqadm/swpost/physical/decorators/excludes = array( 'decorator1' )
		 *
		 ...
		 * @see admin/jqadm/swpost/physical/decorators/global
		 * @see admin/jqadm/swpost/physical/decorators/local
		 */

		/** admin/jqadm/swpost/physical/decorators/global
		 ...
		 *
		 *  admin/jqadm/swpost/physical/decorators/global = array( 'decorator1' )
		 *
		 ...
		 * @category Developer
		 * @see admin/jqadm/common/decorators/default
		 * @see admin/jqadm/swpost/physical/decorators/excludes
		 * @see admin/jqadm/swpost/physical/decorators/local
		 */

		/** admin/jqadm/swpost/physical/decorators/local
		 ...
		 *
		 *  admin/jqadm/swpost/physical/decorators/local = array( 'decorator2' )
		 *
		 ...
		 * @see admin/jqadm/swpost/physical/decorators/global
		 */
		return $this->createSubClient( 'swpost/physical/' . $type, $name );
	}
	...
	{
		/** admin/jqadm/swpost/physical/standard/subparts
		 * List of JQAdm sub-clients rendered within the swpost physical section
		 *
		 ...
		 * @category Developer
		 */
		return $this->getContext()->getConfig()->get( 'admin/jqadm/swpost/physical/standard/subparts', [] );
	}
	...
	protected function fromArray( \Aimeos\MShop\Swpost\Item\Iface $item, array $data ) : \Aimeos\MShop\Swpost\Item\Iface
	{
		...
		$typeManager = \Aimeos\MShop::create( $this->getContext(), 'swpost/property/type' );
	...
	{
		/** admin/jqadm/swpost/physical/template-item
		 * Relative path to the HTML body template of the physical subpart for swposts.
		 *
		 ...
		 * @category Developer
		 */
		$tplconf = 'admin/jqadm/swpost/physical/template-item';
		$default = 'swpost/item-physical-standard';
