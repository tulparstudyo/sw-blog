...
namespace Aimeos\Admin\JQAdm\Swpost\Price\Property;
...
{
	/** admin/jqadm/swpost/price/property/name
	 * Name of the property subpart used by the JQAdm swpost price implementation
	 *
	 * Use "Myname" if your class is named "\Aimeos\Admin\Jqadm\Swpost\Price\Property\Myname".
	...
	{
		/** admin/jqadm/swpost/price/property/decorators/excludes
		 ...
		 *
		 *  admin/jqadm/swpost/price/property/decorators/excludes = array( 'decorator1' )
		 *
		 ...
		 * @see admin/jqadm/swpost/price/property/decorators/global
		 * @see admin/jqadm/swpost/price/property/decorators/local
		 */

		/** admin/jqadm/swpost/price/property/decorators/global
		 ...
		 *
		 *  admin/jqadm/swpost/price/property/decorators/global = array( 'decorator1' )
		 *
		 ...
		 * @category Developer
		 * @see admin/jqadm/common/decorators/default
		 * @see admin/jqadm/swpost/price/property/decorators/excludes
		 * @see admin/jqadm/swpost/price/property/decorators/local
		 */

		/** admin/jqadm/swpost/price/property/decorators/local
		 ...
		 *
		 *  admin/jqadm/swpost/price/property/decorators/local = array( 'decorator2' )
		 *
		 ...
		 * @see admin/jqadm/swpost/price/property/decorators/global
		 */
		return $this->createSubClient( 'swpost/price/property/' . $type, $name );
	}
	...
	{
		/** admin/jqadm/swpost/price/property/standard/subparts
		 * List of JQAdm sub-clients rendered within the swpost price property section
		 *
		 ...
		 * @category Developer
		 */
		return $this->getContext()->getConfig()->get( 'admin/jqadm/swpost/price/property/standard/subparts', [] );
	}
	 ...
	 */
	protected function toArray( \Aimeos\MShop\Swpost\Item\Iface $item, array $data, bool $copy = false ) : array
	{
		$idx = 0;
		$siteId = $this->getContext()->getLocale()->getSiteId();
	...
	{
		/** admin/jqadm/swpost/price/property/template-item
		 ...
		 * @category Developer
		 */
		$tplconf = 'admin/jqadm/swpost/price/property/template-item';
		$default = 'swpost/item-price-property-standard';
