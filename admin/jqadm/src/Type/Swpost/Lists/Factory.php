...
/**
 * Factory for swpost lists type JQAdm client
 *
 * @package Admin
 * @subpackage JQAdm
 */
...
{
	/**
	 * Creates a swpost lists type client object
	 *
	...
	{
		/** admin/jqadm/type/swpost/lists/name
		 ...
		 *
		 *  admin/jqadm/type/swpost/lists/name = Myfavorite
		 *
		 ...
		 */
		if( $name === null ) {
			$name = $context->getConfig()->get( 'admin/jqadm/type/swpost/lists/name', 'Standard' );
		}

		$iface = '\\Aimeos\\Admin\\JQAdm\\Iface';
		$classname = '\\Aimeos\\Admin\\JQAdm\\Type\\Swpost\\Lists\\' . $name;
		...
		return self::addClientDecorators( $context, $client, 'type/swpost/lists' );
	}
