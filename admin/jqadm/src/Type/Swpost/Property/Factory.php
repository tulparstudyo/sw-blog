...
/**
 * Factory for swpost property type JQAdm client
 *
 * @package Admin
 * @subpackage JQAdm
 */
...
{
	/**
	 * Creates a swpost property type client object
	 *
	...
	{
		/** admin/jqadm/type/swpost/property/name
		 ...
		 *
		 *  \Aimeos\Admin\JQAdm\Swpost\Liststype\Standard
		 *
		 * and you want to replace it with your own version named
		 *
		 *  \Aimeos\Admin\JQAdm\Swpost\Liststype\Myfavorite
		 *
		 * then you have to set the this configuration option:
		 *
		 *  admin/jqadm/type/swpost/property/name = Myfavorite
		 *
		 ...
		 */
		if( $name === null ) {
			$name = $context->getConfig()->get( 'admin/jqadm/type/swpost/property/name', 'Standard' );
		}

		$iface = '\\Aimeos\\Admin\\JQAdm\\Iface';
		$classname = '\\Aimeos\\Admin\\JQAdm\\Type\\Swpost\\Property\\' . $name;
		...
		return self::addClientDecorators( $context, $client, 'type/swpost/property' );
	}
