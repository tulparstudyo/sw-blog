...
/**
 * Factory for post property type JQAdm client
 *
 * @package Admin
 * @subpackage JQAdm
 */
...
{
	/**
	 * Creates a post property type client object
	 *
	...
	{
		/** admin/jqadm/type/post/property/name
		 ...
		 *
		 *  \Aimeos\Admin\JQAdm\Post\Liststype\Standard
		 *
		 * and you want to replace it with your own version named
		 *
		 *  \Aimeos\Admin\JQAdm\Post\Liststype\Myfavorite
		 *
		 * then you have to set the this configuration option:
		 *
		 *  admin/jqadm/type/post/property/name = Myfavorite
		 *
		 ...
		 */
		if( $name === null ) {
			$name = $context->getConfig()->get( 'admin/jqadm/type/post/property/name', 'Standard' );
		}

		$iface = '\\Aimeos\\Admin\\JQAdm\\Iface';
		$classname = '\\Aimeos\\Admin\\JQAdm\\Type\\Post\\Property\\' . $name;
		...
		return self::addClientDecorators( $context, $client, 'type/post/property' );
	}
