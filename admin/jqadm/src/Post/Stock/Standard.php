...
namespace Aimeos\Admin\JQAdm\Post\Stock;

sprintf( 'stock' ); // for translation


/**
 * Default implementation of post stock JQAdm client.
 *
 * @package Admin
 * @subpackage JQAdm
 */
...
{
	/** admin/jqadm/post/stock/name
	 * Name of the stock subpart used by the JQAdm post implementation
	 *
	 * Use "Myname" if your class is named "\Aimeos\Admin\Jqadm\Post\Stock\Myname".
	...
	public function addData( \Aimeos\MW\View\Iface $view ) : \Aimeos\MW\View\Iface
	{
		...
		$search->setConditions( $search->compare( '==', 'stock.type.domain', 'post' ) );
	...
	public function delete() : ?string
	{
		...
		$search->setConditions( $search->compare( '==', 'stock.postcode', $code ) );
	...
	{
		/** admin/jqadm/post/stock/decorators/excludes
		 ...
		 *
		 *  admin/jqadm/post/stock/decorators/excludes = array( 'decorator1' )
		 *
		 ...
		 * @see admin/jqadm/post/stock/decorators/global
		 * @see admin/jqadm/post/stock/decorators/local
		 */

		/** admin/jqadm/post/stock/decorators/global
		 ...
		 *
		 *  admin/jqadm/post/stock/decorators/global = array( 'decorator1' )
		 *
		 ...
		 * @category Developer
		 * @see admin/jqadm/common/decorators/default
		 * @see admin/jqadm/post/stock/decorators/excludes
		 * @see admin/jqadm/post/stock/decorators/local
		 */

		/** admin/jqadm/post/stock/decorators/local
		 ...
		 *
		 *  admin/jqadm/post/stock/decorators/local = array( 'decorator2' )
		 *
		 ...
		 * @see admin/jqadm/post/stock/decorators/global
		 */
		return $this->createSubClient( 'post/stock/' . $type, $name );
	}
	...
	{
		/** admin/jqadm/post/stock/standard/subparts
		 * List of JQAdm sub-clients rendered within the post stock section
		 *
		 ...
		 * @category Developer
		 */
		return $this->getContext()->getConfig()->get( 'admin/jqadm/post/stock/standard/subparts', [] );
	}
	...
	protected function toArray( \Aimeos\MShop\Post\Item\Iface $item, bool $copy = false ) : array
	{
		...
		$search = $manager->createSearch();
		$search->setConditions( $search->compare( '==', 'stock.postcode', $item->getCode() ) );
	...
	{
		/** admin/jqadm/post/stock/template-item
		 * Relative path to the HTML body template of the stock subpart for posts.
		 *
		 ...
		 * @category Developer
		 */
		$tplconf = 'admin/jqadm/post/stock/template-item';
		$default = 'post/item-stock-standard';
