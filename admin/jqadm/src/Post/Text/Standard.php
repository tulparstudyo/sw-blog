...
namespace Aimeos\Admin\JQAdm\Post\Text;

sprintf( 'text' ); // for translation


/**
 * Default implementation of post text JQAdm client.
 *
 * @package Admin
 * @subpackage JQAdm
 */
...
{
	/** admin/jqadm/post/text/name
	 * Name of the text subpart used by the JQAdm post implementation
	 *
	...
	public function addData( \Aimeos\MW\View\Iface $view ) : \Aimeos\MW\View\Iface
	{
		...
		$search->setConditions( $search->compare( '==', 'text.type.domain', 'post' ) );
	...
	{
		/** admin/jqadm/post/text/decorators/excludes
		 ...
		 *
		 *  admin/jqadm/post/text/decorators/excludes = array( 'decorator1' )
		 *
		 ...
		 * @see admin/jqadm/post/text/decorators/global
		 * @see admin/jqadm/post/text/decorators/local
		 */

		/** admin/jqadm/post/text/decorators/global
		 ...
		 *
		 *  admin/jqadm/post/text/decorators/global = array( 'decorator1' )
		 *
		 ...
		 * @category Developer
		 * @see admin/jqadm/common/decorators/default
		 * @see admin/jqadm/post/text/decorators/excludes
		 * @see admin/jqadm/post/text/decorators/local
		 */

		/** admin/jqadm/post/text/decorators/local
		 ...
		 *
		 *  admin/jqadm/post/text/decorators/local = array( 'decorator2' )
		 *
		 ...
		 * @see admin/jqadm/post/text/decorators/global
		 */
		return $this->createSubClient( 'post/text/' . $type, $name );
	}
	...
	{
		/** admin/jqadm/post/text/standard/subparts
		 * List of JQAdm sub-clients rendered within the post text section
		 *
		 ...
		 * @category Developer
		 */
		return $this->getContext()->getConfig()->get( 'admin/jqadm/post/text/standard/subparts', [] );
	}
	...
	{
		/** admin/jqadm/post/text/template-item
		 * Relative path to the HTML body template of the text subpart for posts.
		 *
		 ...
		 * @category Developer
		 */
		$tplconf = 'admin/jqadm/post/text/template-item';
		$default = 'post/item-text-standard';
