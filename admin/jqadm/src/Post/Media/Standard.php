	...
	implements \Aimeos\Admin\JQAdm\Common\Admin\Factory\Iface
{
	...
	/**
	 * Adds the post variant attributes to the media item
	 * Then, the images will only be shown if the customer selected the post variant
	 *
	 * @param \Aimeos\MShop\Media\Item\Iface $mediaItem Media item, maybe with referenced attribute items
	 * @param \Aimeos\MShop\Common\Item\Lists\Iface[] $attrListItems Post list items referencing variant attributes
	 ...
	 */
	protected function deleteMediaItems( \Aimeos\MShop\Post\Item\Iface $item, \Aimeos\Map $listItems ) : \Aimeos\MShop\Post\Item\Iface
	{
		$context = $this->getContext();
		...
		{
			$func = $search->createFunction( 'post:has', ['media', $listItem->getType(), $listItem->getRefId()] );
	...
	{
		/** admin/jqadm/post/media/standard/subparts
		 ...
		 * @category Developer
		 */
		return $this->getContext()->getConfig()->get( 'admin/jqadm/post/media/standard/subparts', [] );
	}
