	...
	implements \Aimeos\Admin\JQAdm\Common\Admin\Factory\Iface
{
	...
	public function delete() : ?string
	{
		...
		$expr = array(
			...
			$search->compare( '==', 'catalog.lists.domain', 'post' )
		);
	...
	{
		/** admin/jqadm/post/category/standard/subparts
		 ...
		 * @category Developer
		 */
		return $this->getContext()->getConfig()->get( 'admin/jqadm/post/category/standard/subparts', [] );
	}
	...
	protected function fromArray( \Aimeos\MShop\Post\Item\Iface $item, array $data )
	{
		...
		foreach( $data as $idx => $entry )
		{
			...
			$list[] = $litem->setParentId( $this->getValue( $entry, 'catalog.id' ) )->setDomain( 'post' )
