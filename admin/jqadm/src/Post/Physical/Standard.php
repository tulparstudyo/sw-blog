...
namespace Aimeos\Admin\JQAdm\Post\Physical;

sprintf( 'physical' ); // for translation


/**
 * Default implementation of post physical JQAdm client.
 *
 * @package Admin
 * @subpackage JQAdm
 */
...
{
	/** admin/jqadm/post/physical/name
	 * Name of the physical subpart used by the JQAdm post implementation
	 *
	 * Use "Myname" if your class is named "\Aimeos\Admin\Jqadm\Post\Physical\Myname".
	...
	public function create() : ?string
	{
		...
		foreach( $view->value( $data, 'post.property.id', [] ) as $idx => $value ) {
			$data['post.property.siteid'][$idx] = $siteid;
		}
	...
	{
		/** admin/jqadm/post/physical/decorators/excludes
		 ...
		 *
		 *  admin/jqadm/post/physical/decorators/excludes = array( 'decorator1' )
		 *
		 ...
		 * @see admin/jqadm/post/physical/decorators/global
		 * @see admin/jqadm/post/physical/decorators/local
		 */

		/** admin/jqadm/post/physical/decorators/global
		 ...
		 *
		 *  admin/jqadm/post/physical/decorators/global = array( 'decorator1' )
		 *
		 ...
		 * @category Developer
		 * @see admin/jqadm/common/decorators/default
		 * @see admin/jqadm/post/physical/decorators/excludes
		 * @see admin/jqadm/post/physical/decorators/local
		 */

		/** admin/jqadm/post/physical/decorators/local
		 ...
		 *
		 *  admin/jqadm/post/physical/decorators/local = array( 'decorator2' )
		 *
		 ...
		 * @see admin/jqadm/post/physical/decorators/global
		 */
		return $this->createSubClient( 'post/physical/' . $type, $name );
	}
	...
	{
		/** admin/jqadm/post/physical/standard/subparts
		 * List of JQAdm sub-clients rendered within the post physical section
		 *
		 ...
		 * @category Developer
		 */
		return $this->getContext()->getConfig()->get( 'admin/jqadm/post/physical/standard/subparts', [] );
	}
	...
	protected function fromArray( \Aimeos\MShop\Post\Item\Iface $item, array $data ) : \Aimeos\MShop\Post\Item\Iface
	{
		...
		$typeManager = \Aimeos\MShop::create( $this->getContext(), 'post/property/type' );
	...
	{
		/** admin/jqadm/post/physical/template-item
		 * Relative path to the HTML body template of the physical subpart for posts.
		 *
		 ...
		 * @category Developer
		 */
		$tplconf = 'admin/jqadm/post/physical/template-item';
		$default = 'post/item-physical-standard';
