...
namespace Aimeos\Admin\JQAdm\Post\Price\Property;
...
{
	/** admin/jqadm/post/price/property/name
	 * Name of the property subpart used by the JQAdm post price implementation
	 *
	 * Use "Myname" if your class is named "\Aimeos\Admin\Jqadm\Post\Price\Property\Myname".
	...
	{
		/** admin/jqadm/post/price/property/decorators/excludes
		 ...
		 *
		 *  admin/jqadm/post/price/property/decorators/excludes = array( 'decorator1' )
		 *
		 ...
		 * @see admin/jqadm/post/price/property/decorators/global
		 * @see admin/jqadm/post/price/property/decorators/local
		 */

		/** admin/jqadm/post/price/property/decorators/global
		 ...
		 *
		 *  admin/jqadm/post/price/property/decorators/global = array( 'decorator1' )
		 *
		 ...
		 * @category Developer
		 * @see admin/jqadm/common/decorators/default
		 * @see admin/jqadm/post/price/property/decorators/excludes
		 * @see admin/jqadm/post/price/property/decorators/local
		 */

		/** admin/jqadm/post/price/property/decorators/local
		 ...
		 *
		 *  admin/jqadm/post/price/property/decorators/local = array( 'decorator2' )
		 *
		 ...
		 * @see admin/jqadm/post/price/property/decorators/global
		 */
		return $this->createSubClient( 'post/price/property/' . $type, $name );
	}
	...
	{
		/** admin/jqadm/post/price/property/standard/subparts
		 * List of JQAdm sub-clients rendered within the post price property section
		 *
		 ...
		 * @category Developer
		 */
		return $this->getContext()->getConfig()->get( 'admin/jqadm/post/price/property/standard/subparts', [] );
	}
	...
	{
		/** admin/jqadm/post/price/property/template-item
		 ...
		 * @category Developer
		 */
		$tplconf = 'admin/jqadm/post/price/property/template-item';
		$default = 'post/item-price-property-standard';
