				...
				<tr>
					<th>
						...
						<div class="form-text text-muted help-text">
							<?= $enc->html( $this->translate( 'admin', 'Categories the swpost can be found in by the user on the web site' ) ); ?>
						</div>
					</th>
					<th class="actions">
			...
			<thead>
				<tr>
					<th>
						...
						<div class="form-text text-muted help-text">
							<?= $enc->html( $this->translate( 'admin', 'Categories the swpost will be shown for in the promotional section' ) ); ?>
						</div>
					</th>
					<th class="actions">
						<div class="btn act-add fa" tabindex="<?= $this->get( 'tabindex' ); ?>"
